...
namespace BooksStore.Controllers
{
    public class usersaccountsController : Controller
    {
        ...
        {
            SqlConnection conn1 = new SqlConnection("Data Source=(LocalDB)\\MSSQLLocalDB;AttachDbFilename=C:\\Users\\Toshiba\\Documents\\mynewdb3.mdf;Integrated Security=True;Connect Timeout=30");
            string sql;
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'BooksStoreContext.usersaccounts'  is null.");
            }
            var usersaccounts = await _context.usersaccounts.FindAsync(id);
